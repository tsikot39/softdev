while (!player1) {
  var player1 = prompt("Player 1: Enter your name. You will be color RED.");
}
var player1Color = "red";

while (!player2) {
  var player2 = prompt(
    "Player Two: Enter your name. You will be color YELLOW."
  );
}
...
function colorMatchCheck(one, two, three) {
  return one === two && one === three && one !== "white" && one !== undefined;
}
